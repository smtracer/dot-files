...
(let ((class '((class color) (min-colors 89)))
      ...
      (subtle "#908caa")
      (text "#e0def4")
      (text-selection "#323142")

      (love "#eb6f92")
      (gold "#f6c177")
      (gold-selection "#342e37")
      (rose "#ea9a97")
      (rose-selection "#332d3d")
      (pine "#3e8fb0")
      (pine-selection "#232638")
      (foam "#9ccfd8")
      (foam-selection "#2d2f3f")
      (iris "#c4a7e7")
      (iris-selection "#2f2b40")
      (hllow "#2a283e")
      (hlmed "#44415a")
      (hlhi "#56526e"))
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,love))))
   `(font-lock-comment-face ((,class (:foreground ,muted))))
;   `(font-lock-negation-char-face ((,class (:foreground ,muted))))
;   `(font-lock-reference-face ((,class (:foreground ,muted))))
   `(font-lock-constant-face ((,class (:foreground ,iris))))
   `(font-lock-doc-face ((,class (:foreground ,muted))))
   `(font-lock-function-name-face ((,class (:foreground ,rose :bold t))))
   ...
   `(font-lock-warning-face ((,class (:foreground ,gold :background ,gold-selection))))
   `(region ((,class (:background ,hlmed :foreground ,text))))

   `(line-number ((,class (:foreground ,muted))))
   `(line-number-current-line ((,class (:foreground ,text))))
   
;   `(mode-line ((,class (:bold nil :foreground ,rose :background ,rose-selection))))
   `(mode-line ((,class (:bold nil :foreground ,iris :background ,iris-selection))))
   `(mode-line-inactive ((,class (:bold nil :foreground ,muted :background ,surface))))
   `(doom-modeline-buffer-modified ((,class (:inherit mode-line))))

;   `(mode-line-buffer-id ((,class (:bold t :foreground ,foam)))) ;
   ...
   `(vertical-border                          ((,class (:foreground ,surface))))
